    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
      <div className="bg-white rounded-xl w-full max-w-md p-6">
        ...
        <div className="flex gap-3">
          <button className="flex-1 bg-blue-600 text-white py-2 rounded" onClick={onClose}>Log in</button>
          <button className="flex-1 border py-2 rounded" onClick={() => { onClose(); onOpenSignup?.(); }}>Sign Up</button>
        </div>
